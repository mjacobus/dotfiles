...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey,           }, "a", function () awful.spawn("google-chrome --new-window https://chatgpt.com") end,
    {description = "open chatgpt", group = "launcher"}),
  awful.key({ modkey,           }, "c", function () awful.spawn("google-chrome --new-window https://calendar.google.com/calendar/u/0/r") end,
    {description = "open calendar (personal)", group = "launcher"}),
  awful.key({ modkey, "Shift"   }, "c", function () awful.spawn("google-chrome --new-window https://calendar.google.com/calendar/u/1/r") end,
    {description = "open calendar (work)", group = "launcher"}),
  awful.key({ modkey,           }, "s", function () awful.spawn("google-chrome --new-window https://app.slack.com/client/T090AJD0EAG/C090AJD8J4C") end,
    {description = "open credclub slack", group = "launcher"}),
  awful.key({ modkey, "Shift"   }, "s", function () awful.spawn("google-chrome --new-window https://app.slack.com/client/T0KHRPJJJ") end,
    {description = "open work slack", group = "launcher"}),
  awful.key({ modkey,           }, "e", function () awful.spawn("google-chrome --new-window https://mail.google.com/mail/u/0/#inbox") end,
    {description = "open email (personal)", group = "launcher"}),
  awful.key({ modkey, "Shift"   }, "e", function () awful.spawn("google-chrome --new-window https://mail.google.com/mail/u/1/#inbox") end,
    {description = "open email (work)", group = "launcher"}),
  awful.key({ modkey,           }, "y", function () awful.spawn("google-chrome --new-window https://youtube.com/") end,
    {description = "open youtube", group = "launcher"}),
  awful.key({ modkey, "Shift"   }, "w", function () awful.spawn("google-chrome --new-window https://web.whatsapp.com/") end,
