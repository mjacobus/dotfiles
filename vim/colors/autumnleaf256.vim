...
hi Cursor	guibg=#aa7733 ctermbg=137   guifg=#ffeebb   gui=bold
hi Normal	guibg=#fffdfa	guifg=black	gui=none ctermbg=15
hi NonText	guibg=#eafaea ctermbg=7   guifg=#000099   gui=bold
...
hi Comment guibg=#ddeedd ctermbg=7 guifg=#002200 gui=none
...
hi SpecialComment   guibg=#dddddd ctermbg=253   guifg=#aa0000   gui=none
