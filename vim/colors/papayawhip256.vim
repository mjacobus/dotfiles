...
hi Normal guifg=#3f1f1f ctermfg=235 guibg=PapayaWhip ctermbg=Gray ctermfg=Black
...
hi StatusLine guibg=White guifg=#5f3705 ctermfg=58 cterm=bold ctermbg=Brown ctermfg=White
