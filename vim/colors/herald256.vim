...
if has("gui_running")
	...
	" -> Text; Miscellaneous
	hi Normal         guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=none
	hi SpecialKey     guibg=#1F1F1F ctermbg=234 guifg=#E783E9 gui=none
	hi VertSplit      guibg=#1F1F1F ctermbg=234 guifg=#FFEE68 gui=none
	hi SignColumn     guibg=#1F1F1F ctermbg=234 guifg=#BF81FA gui=none
	hi NonText        guibg=#1F1F1F ctermbg=234 guifg=#FC6984 gui=none
	hi Directory      guibg=#1F1F1F ctermbg=234 guifg=#FFEE68 gui=none 
	hi Title          guibg=#1F1F1F ctermbg=234 guifg=#6DF584 gui=bold

	" -> Cursor 
	hi Cursor         guibg=#FFEE68 ctermbg=227 guifg=#1F1F1F gui=none
	hi CursorIM       guibg=#FFEE68 ctermbg=227 guifg=#1F1F1F gui=none
	hi CursorColumn   guibg=#000000 ctermbg=0               gui=none
	hi CursorLine     guibg=#000000 ctermbg=0               gui=none

	" -> Folding
	hi FoldColumn     guibg=#001336 ctermbg=234 guifg=#003DAD gui=none
	hi Folded         guibg=#001336 ctermbg=234 guifg=#003DAD gui=none

	" -> Line info  
	hi LineNr         guibg=#000000 ctermbg=0 guifg=#696567 gui=none
	hi StatusLine     guibg=#000000 ctermbg=0 guifg=#696567 gui=none
	hi StatusLineNC   guibg=#25365a ctermbg=237 guifg=#696567 gui=none

	" -> Messages
	hi ErrorMsg       guibg=#A32024 ctermbg=124 guifg=#D0D0D0 gui=none
	hi Question       guibg=#1F1F1F ctermbg=234 guifg=#FFA500 gui=none
	hi WarningMsg     guibg=#FFA500 ctermbg=214 guifg=#000000 gui=none
	hi MoreMsg        guibg=#1F1F1F ctermbg=234 guifg=#FFA500 gui=none
	hi ModeMsg        guibg=#1F1F1F ctermbg=234 guifg=#FFA500 gui=none

	" -> Search 
	hi Search         guibg=#696567 ctermbg=241 guifg=#FFEE68 gui=none 
	hi IncSearch      guibg=#696567 ctermbg=241 guifg=#FFEE68 gui=none

	" -> Diff
	hi DiffAdd        guibg=#006124 ctermbg=22 guifg=#ED9000 gui=none
	hi DiffChange     guibg=#0B294A ctermbg=235 guifg=#A36000 gui=none
	hi DiffDelete     guibg=#081F38 ctermbg=234 guifg=#ED9000 gui=none
	hi DiffText       guibg=#12457D ctermbg=24 guifg=#ED9000 gui=underline

	" -> Menu
	hi Pmenu          guibg=#140100 ctermbg=0 guifg=#660300 gui=none
	hi PmenuSel       guibg=#F17A00 ctermbg=208 guifg=#4C0200 gui=none
	hi PmenuSbar      guibg=#430300 ctermbg=52               gui=none
	hi PmenuThumb     guibg=#720300 ctermbg=52               gui=none
	hi PmenuSel       guibg=#F17A00 ctermbg=208 guifg=#4C0200 gui=none

	" -> Tabs
	hi TabLine        guibg=#141414 ctermbg=233 guifg=#1F1F1F gui=none
	hi TabLineFill    guibg=#000000 ctermbg=0               gui=none
	hi TabLineSel     guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=bold  
	"
	" -> Visual Mode
	hi Visual         guibg=#000000 ctermbg=0 guifg=#FFB539 gui=none
	hi VisualNOS      guibg=#000000 ctermbg=0 guifg=#696567 gui=none

	" -> Code
	hi Comment        guibg=#1F1F1F ctermbg=234 guifg=#696567 gui=none
	hi Constant       guibg=#1F1F1F ctermbg=234 guifg=#6DF584 gui=none
	hi String         guibg=#1F1F1F ctermbg=234 guifg=#FFB539 gui=none
	hi Error          guibg=#1F1F1F ctermbg=234 guifg=#FC4234 gui=none
	hi Identifier     guibg=#1F1F1F ctermbg=234 guifg=#70BDF1 gui=none
	hi Function       guibg=#1F1F1F ctermbg=234 guifg=#90CBF1 gui=none
	hi Ignore         guibg=#1F1F1F ctermbg=234 guifg=#1F1F1F gui=none
	hi MatchParen     guibg=#FFA500 ctermbg=214 guifg=#1F1F1F gui=none
	hi PreProc        guibg=#1F1F1F ctermbg=234 guifg=#BF81FA gui=none
	hi Special        guibg=#1F1F1F ctermbg=234 guifg=#FFEE68 gui=none
	hi Todo           guibg=#1F1F1F ctermbg=234 guifg=#FC4234 gui=bold
	hi Underlined     guibg=#1F1F1F ctermbg=234 guifg=#FC4234 gui=underline
	hi Statement      guibg=#1F1F1F ctermbg=234 guifg=#E783E9 gui=none
	hi Operator       guibg=#1F1F1F ctermbg=234 guifg=#FC6984 gui=none
	hi Delimiter      guibg=#1F1F1F ctermbg=234 guifg=#FC6984 gui=none
	hi Type           guibg=#1F1F1F ctermbg=234 guifg=#FFEE68 gui=none
	hi Exception      guibg=#1F1F1F ctermbg=234 guifg=#FC4234 gui=none

	" -> HTML-specific
	hi htmlBold                 guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=bold
	hi htmlBoldItalic           guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=bold,italic
	hi htmlBoldUnderline        guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=bold,underline
	hi htmlBoldUnderlineItalic  guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=bold,underline,italic
	hi htmlItalic               guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=italic
	hi htmlUnderline            guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=underline
	hi htmlUnderlineItalic      guibg=#1F1F1F ctermbg=234 guifg=#D0D0D0 gui=underline,italic
