...
hi Cursor          guifg=#000000 ctermfg=0 guibg=#F8F8F0
...
hi DiffChange      guifg=#89807D ctermfg=244 guibg=#4C4745
hi DiffDelete      guifg=#960050 ctermfg=89 guibg=#1E0010
hi DiffText                      guibg=#4C4745 ctermbg=238 gui=italic,bold

hi Directory       guifg=#A6E22E ctermfg=148               gui=bold
hi Error           guifg=#960050 ctermfg=89 guibg=#1E0010
hi ErrorMsg        guifg=#F92672 ctermfg=197 guibg=#232526 gui=bold
hi Exception       guifg=#A6E22E ctermfg=148               gui=bold
hi Float           guifg=#AE81FF ctermfg=141
hi FoldColumn      guifg=#465457 ctermfg=239 guibg=#000000
hi Folded          guifg=#465457 ctermfg=239 guibg=#000000
hi Function        guifg=#A6E22E ctermfg=148
hi Identifier      guifg=#FD971F ctermfg=208
hi Ignore          guifg=#808080 ctermfg=244 guibg=bg
hi IncSearch       guifg=#C4BE89 ctermfg=180 guibg=#000000
...
hi Search          guifg=#FFFFFF ctermfg=15 guibg=#455354
" marks column
hi SignColumn      guifg=#A6E22E ctermfg=148 guibg=#232526
...
hi StatusLineNC    guifg=#808080 ctermfg=244 guibg=#080808
...
hi VertSplit       guifg=#808080 ctermfg=244 guibg=#080808 gui=bold
hi VisualNOS                     guibg=#403D3D ctermbg=237
hi Visual                        guibg=#403D3D ctermbg=237
hi WarningMsg      guifg=#FFFFFF ctermfg=15 guibg=#333333 gui=bold
hi WildMenu        guifg=#66D9EF ctermfg=81 guibg=#000000

if s:molokai_original == 1
   hi Normal          guifg=#F8F8F2 ctermfg=15 guibg=#272822
   hi Comment         guifg=#75715E ctermfg=242
   hi CursorLine                    guibg=#3E3D32 ctermbg=237
   hi CursorColumn                  guibg=#3E3D32 ctermbg=237
   hi LineNr          guifg=#BCBCBC ctermfg=250 guibg=#3B3A32
   hi NonText         guifg=#BCBCBC ctermfg=250 guibg=#3B3A32
else
   hi Normal          guifg=#F8F8F2 ctermfg=15 guibg=#1B1D1E
   hi Comment         guifg=#465457 ctermfg=239
   hi CursorLine                    guibg=#293739 ctermbg=236
   hi CursorColumn                  guibg=#293739 ctermbg=236
   hi LineNr          guifg=#BCBCBC ctermfg=250 guibg=#232526
   hi NonText         guifg=#BCBCBC ctermfg=250 guibg=#232526
end
